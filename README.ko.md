...
> [OpenAI 공식 GPT Image 2 프롬프트 가이드](https://developers.openai.com/cookbook/examples/multimodal/image-gen-models-prompting-guide)를 기반으로 합니다.
...
| **비용** | 이미지당 API 과금 | ✅ **ChatGPT Plus/Pro OAuth로 무료** |
